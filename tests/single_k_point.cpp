...
int main(int argc, char** argv) {
    ...
    // Greens function
    auto c_time_evolution = [&system](std::vector<HHG::h_complex>& c_alphas, std::vector<HHG::h_complex>& c_betas,
                                      HHG::Laser const* const laser, HHG::h_float k_z, HHG::h_float kappa,
                                      const HHG::TimeIntegrationConfig& time_config) {
