...
HHG::Dispatch::HoneycombDispatcher::HoneycombDispatcher(mrock::utility::InputFileReader& input,
                                                        int N,
    ...
    if (laser_type == continuous) {
        ...
        laser = std::make_unique<Laser::PowerLawField>(photon_energy, E0, system.laser_model_ratio(), t0_offset,
...
nlohmann::json HHG::Dispatch::HoneycombDispatcher::special_information() const {
    return {{"lattice_constant", system.get_property_in_SI_units("d", photon_energy)},
