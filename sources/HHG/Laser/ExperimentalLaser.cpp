...
namespace HHG::Laser {
    ...
    void ExperimentalLaser::compute_spline()
    {
        ...
        auto add_laser = [this](const h_float EA, const h_float EB) -> h_float {
        ...
        for(int i = 0; i < N_main; ++i) {
            ...
            if (second_laser_shift >= 0) {
                ...
                __temp[i] = -add_laser(__A, __B) * dt / fac;
            }
            else {
