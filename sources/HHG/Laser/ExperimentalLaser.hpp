...
namespace HHG::Laser {
    struct ExperimentalLaser : public Laser {
        ...
        constexpr static h_float exp_photon_frequency{6.160623605094333}; ///< in meV [obtained by FFT of the measured electric field]
        ...
        ExperimentalLaser(h_float _photon_energy, h_float _E_0, h_float model_ratio, h_float _second_laser_shift);
