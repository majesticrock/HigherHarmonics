...
for value in "${values[@]}"; do
    sed -i "s/^$name.*/$name $value/" "params/cascade_experiment_A.config"
    sed -i "s/^$name.*/$name $value/" "params/cascade_experiment_B.config"
    sed -i "s/^$name.*/$name $value/" "params/cascade_experiment.config"
